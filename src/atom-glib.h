...
void atom_text_editor_set_cursor_screen_position(AtomTextEditor *, gint, gint);
void atom_text_editor_select_to_screen_position(AtomTextEditor *, gint, gint, gboolean);
void atom_text_editor_select_word(AtomTextEditor *);
void atom_text_editor_select_line(AtomTextEditor *);
void atom_text_editor_add_cursor_at_screen_position(AtomTextEditor *, gint, gint);
void atom_text_editor_toggle_cursor_at_screen_position(AtomTextEditor *, gint, gint);
void atom_text_editor_merge_intersecting_selections(AtomTextEditor *);
void atom_text_editor_finalize_selections(AtomTextEditor *);
